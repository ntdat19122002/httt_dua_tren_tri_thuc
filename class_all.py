...
class ConvertData:
    ...
    def convertbenh(self):
        ...
        dbbenh = mydb.cursor()
        # Lấy ra tất cả các bệnh trong database benhcum
        dbbenh.execute("SELECT * FROM benhcum.benh;")
    ...
    def converttrieuchung(self):
        ...
        dbtrieuchung.execute("SELECT * FROM benhcum.trieuchung;")
    ...
    def gettrieuchung(self):
        ...
        """
        dbtrieuchung=mydb.cursor()
        dbtrieuchung.execute("SELECT * FROM benhcum.suydien order by idbenh")
